...
The server served data from a data stream.
...
We open the connection which starts the data generating process. `retry` is
used to make sure the server connections are established.
...
returns the name of the task file. 
