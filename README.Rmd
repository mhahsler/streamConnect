...
See [stream: Working With Data Streams using Connections and Web Services](https://cran.r-project.org/web/packages/streamConnect/vignettes/connections.html)
for examples.
